...
##############
        camid = args.camid
        image1test_path = os.path.join(
            IMAGE_FOLD_PATH, 'data/TestImages', args.image1test)
        image2perfect_path = os.path.join(
            IMAGE_FOLD_PATH, 'data/TestImages', args.image2perfect)
