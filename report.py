...
def generate_report(camid,test_img_path,perfect_img_path):
    ...
    test_img = cv2.resize(test_img, (IMG_WIDTH, IMG_HEIGHT), interpolation = cv2.INTER_NEAREST)
    perfect_img = cv2.resize(perfect_img, (IMG_WIDTH, IMG_HEIGHT), interpolation = cv2.INTER_NEAREST)
